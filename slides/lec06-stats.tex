...
\begin{itemize}
\item Compound verbs (VV): 光り輝く \jpn[shine-sparkle]{hikari-kagayaku}; 
  書き上げる \jpn[write up (lit: write-rise)]{kaki-ageru}
\item Particle Verbs (PV): \eng{give up}, \eng{write up}
...
\item Semantically they are both examples of verb+satellite
  ...
  \end{itemize}
\end{itemize}
\myslide{Do Particle verbs correlate with compound verbs? II}
...
\begin{center}
  \begin{tabular}{l|rrr}
      & PV & V  &  total \\ \hline
   VV &   1,777 &  5,885  & 7,662  \\ %(+ 1777 5885) 7662
    V &  10,877 & 51,137  &  62,014      \\ %(+ 10877 51137) 62014
    total &  12,654 & 57,022 &  69,676\\
% (+ 1777 10877) 12654  (+ 5885 51137) 57022 (+ 7662 62014)69676
...
\end{center}
  ...
  \item How many PV=VV would you expect if they were independent?
    ...
    % (* 0.1236  0.1492  69676) 1284.9034771200002
  \item Is PV translated as VV more than chance?
    \\ upper bound is $0.1262 \times 0.1518 \times 69676 = 1,334.8$
    % (* 0.1262  0.1518  69676) 1334.79428016
  \end{itemize}

\myslide{Do Particle verbs correlate with compound verbs? III}
...
\MyLogo{My great-grand-supervisor: Bond ← Huddleston ← Halliday ← Firth}
\begin{itemize}
