...
\MyLogo{\url{http://arxiv.org/abs/1104.2086} and \url{http://code.google.com/p/universal-pos-tags/} UD ver 2}
{\small
  \noindent
  \begin{tabular}{lll}
...
\item  ex. \eng{lie} in:
  \begin{itemize}
  \item  \eng{The boy lies\,$_1$ to his parents.}
  \item  \eng{Mary lies\,$_2$ down after lunch for  a nap.}
  \end{itemize}
\item  ex. \eng{share} in:
  \begin{itemize}
  \item  \eng{They all did their share\,$_1$ of the work.}
  \item  \eng{The Twitter share\,$_2$ holders  were disappointed.}
  \end{itemize}
\end{itemize}
...
\myslide{\engcor Interface Specialties}
\MyLogo{\url{https://www.english-corpora.org/queries.asp}}
\begin{small}
  \begin{tabular}{llll}
