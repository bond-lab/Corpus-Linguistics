...
\begin{enumerate}
\item \blu{decide on the structural criteria} that you will use to build the corpus, and apply then to create a framework for the principal corpus components;
...
\item[NC] Non-Commercial \com{not open source}
\item[ND] No Derivatives (allows only exact copies) \com{not open source}
\end{description}
