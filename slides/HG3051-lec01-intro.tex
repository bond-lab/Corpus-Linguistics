...
\myslide{HG3051 Prerequisites: HG1002 or HG2051}
...
\item[LEXICO-GRAMMAR]: Look at the top five adjectives following \eng{come} and \eng{go} ( use [COMPARE WORDS]; WORD(S) = come , go; CONTEXT =  [j*] [0] [2]). Is there any pattern in terms of which adjectives occur with the two verbs?
\newpage
