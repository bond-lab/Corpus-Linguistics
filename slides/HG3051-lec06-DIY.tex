...
\myslide{Many corpora are stored as SQL}

\begin{itemize}
\item \txx{Structured Query Language} is a special-purpose
programming language designed for managing data held in a relational
database management system (RDBMS)
\item Data is stored in \txx{Table}s
  \begin{itemize}
  \item Tables can be joined together
  \end{itemize}
\item It can be retrieved with \txx{Queries}
  \begin{itemize}
